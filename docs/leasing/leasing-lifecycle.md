...
SOP: [TPS — Property & Trade Me Setup](../onboarding/tps-property-setup.md)
...
!!! warning "Tenant-in-place viewings"
    Coordinate politely and aim for a time window. Keep changes minimal and record confirmations in writing.

SOP: [Viewings & BookMe (TPS)](tps-viewings-bookme.md)
...
!!! warning "Privacy rule"
    Run background/credit checks only on preferred applicant(s) — not on all applicants.

SOP: [Application Processing (TPS)](tps-application-processing.md)
