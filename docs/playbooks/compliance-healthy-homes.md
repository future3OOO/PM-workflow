# PLAYBOOK — Compliance: Healthy Homes (Pre‑Tenancy + Ongoing Tracking) (Version 2)
...
Collect what exists:
- Healthy Homes assessment/report (if any)
...
- Smoke alarm info (not a Healthy Homes standard but operationally tracked)
...
- for routine work seek owner approval first
