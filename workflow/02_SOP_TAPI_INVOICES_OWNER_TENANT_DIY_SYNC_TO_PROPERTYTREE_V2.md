# SOP — Tapi: Invoice Processing & Sync to Property Tree (Version 2)

**Version:** V2.2 (Updated from video walkthroughs — Entering Invoices 1 & 2)  
...
> **Key rule:** Tapi ingests PDF attachments only. Links to invoice portals, Google Drive, Xero, or similar will not be picked up. Always verify a PDF is physically attached to the email before forwarding.
...
> Source: Video 6 — Entering Invoices 1
...
> Source: Video 7 — Entering Invoices 2
