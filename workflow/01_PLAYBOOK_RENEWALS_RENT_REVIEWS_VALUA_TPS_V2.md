# PLAYBOOK — Renewals + Rent Reviews (Valua + TPS Renewals/Extensions) (Version 2)
...
### V2 escalation rule
No response after:
- 2 follow-up emails → 1 phone call attempt → final deadline email
...
## Stage 5 — Execute in TPS and update Property Tree
...
- rent review summary
- rent increase notice (attach formal notice letter if needed)
