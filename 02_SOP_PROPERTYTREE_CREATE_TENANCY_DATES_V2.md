# SOP — Property Tree: Create Tenancy + Perfect Dates + Upload Docs (Version 2)
...
## Quality checks
- Dates match agreement exactly
- Rent matches agreement
- Agreement stored in the property record
- Bond status tracked until confirmed
